...
public class Controlador {
	 ...
	 *
	 * @param vistas Un arreglo de objetos Vista que representan las vistas a establecer.
	 */
	 ...
	 * @return Un objeto TableModel que representa la tabla correspondiente al campo especificado.
	 */
	 ...
	 * Muestra diferentes vistas dependiendo del resultado del inicio de sesión.
	 */
	public void login() {
	...
	/**
	 * Avanza en el proceso de registro, mostrando la siguiente parte del formulario si es posible.
	 * Muestra mensajes de error si hay algún problema con los datos proporcionados.
	 */
	 ...
	 * Realiza la verificación de los datos proporcionados y muestra mensajes de error si es necesario.
	 */
	public void singIn() {
	...
	/**
	 * Verifica y procesa el cambio de contraseña de un usuario.
	 * Muestra un mensaje de error si no se pueden verificar los datos correctamente.
	 */
	...
	/**
	 * Establece los datos del usuario actual en la vista de perfil.
	 * Actualiza los campos con la información del usuario.
	 */
	...
	/**
	 * Actualiza los datos del usuario con la información proporcionada en la vista de perfil.
	 * Realiza validaciones sobre los datos proporcionados y muestra mensajes de éxito o error en la vista.
	 */
	...
	/**
	 * Convierte una imagen representada por un ImageIcon a su representación en formato Base64.
	 *
	...
	/**
	 * Crea una nueva publicación con la información proporcionada.
	 * Verifica la validez de los datos y muestra mensajes de error si es necesario.
	 */
	...
	/**
	 * Carga los datos de una publicación desde el modelo y los muestra en la vista de publicación.
	 * Actualiza los campos de la vista con los datos obtenidos.
	 */
	...
	/**
	 * Carga una imagen desde el sistema de archivos y la devuelve como un ImageIcon escalado a la altura especificada.
	 *
	 * @param alturaImagen La altura deseada para la imagen escalada.
	 * @return Un ImageIcon escalado con la imagen seleccionada, o null si no se seleccionó ninguna imagen.
	 */
	 ...
	 * @return Un TableModel que contiene los datos de la tabla correspondiente a la página especificada.
	 */
	...
	/**
	 * Prepara la vista de una publicación utilizando el valor proporcionado como referencia.
	 * Obtiene los datos de la publicación correspondiente desde el modelo.
	 *
	...
	/**
	 * Aprueba o deniega una denuncia según el código de denuncia y el tipo especificados.
	 *
	 * @param codigoDenuncia El código de la denuncia que se desea aprobar o denegar.
	...
	/**
	 * Modifica una columna específica de una denuncia según el código de denuncia, el nombre de la columna y el texto especificados.
	 *
	 ...
	 * @param text           El nuevo valor que se desea asignar a la columna especificada.
	 */
